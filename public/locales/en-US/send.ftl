...
notSupportedOutdatedDetail = Unfortunately this version of Firefox does not support the web technology that powers Fubukifox Send. You’ll need to update your browser.
